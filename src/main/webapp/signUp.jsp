...
<div class="main d-flex flex-column justify-content-between">
    ...
    <div class="justify-content-center oval container-fluid">
        <form  action="${context}/p/signUp" method="post">
            <h1 class="text-center" style="font-family: 'Oswald';font-weight: normal; font-size: 64px; line-height: 90px;">Добро пожаловать на</h1>
            ...
            <div class="form-group row my-3">
                <div class="col-12 row d-flex justify-content-center">
                    <button type="submit" class="btn col-2" id="asseptSighUp" style="background-color: #FEBCFF;">Sign up</button>
                </div>
            </div>
        </form>
    </div>
